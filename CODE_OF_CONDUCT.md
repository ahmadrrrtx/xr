...
XR is a project about **evidence over claims**. Technical disagreement is welcome and
expected — challenge a benchmark, a security assertion, or a line in the README, and bring
the evidence. Critique the claim, not the person. Reports that a documented capability does
not match reality are treated as valuable contributions, not as attacks, and have their own
[issue template](.github/ISSUE_TEMPLATE/false_claim.yml).
...
This Code of Conduct applies within all community spaces — the GitHub repository, issues,
pull requests, discussions and releases — and also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainer privately through
[GitHub Security Advisories](https://github.com/ahmadrrrtx/xr/security/advisories/new) (which
is private and works for conduct reports as well as vulnerabilities), or by contacting
[@ahmadrrrtx](https://github.com/ahmadrrrtx) directly on GitHub.
