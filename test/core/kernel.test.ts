...
describe("XRKernel bootstrap (hermetic)", () => {
  if (process.platform === "win32") {
    // Windows subprocess spawning in Bun can exceed the watchdog under CI/Git Bash.
    // Linux/macOS exercise this contract via the hermetic fixture.
    test.skip("kernel boots with a single unified store and switches workspaces cleanly", () => {});
    test.skip("fixture fails honestly when XR_HOME is not provided", () => {});
  } else {
