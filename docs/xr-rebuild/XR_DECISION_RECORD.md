...
| D-05 | Brand source of truth | **Official avatar + official logo renders are the single source of truth, used EXACTLY as provided** (owner-supplied originals, 2026-09-17); no derived/re-drawn geometry anywhere in product surfaces — derived SVG mark removed (commit e290836) | Asset Audit §4 + Design System §1 amended: placement rules only, never redraw |
