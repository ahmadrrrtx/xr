...
- Per-release snapshots (e.g.
  [`docs/release/7.1.0/known-limitations.md`](../release/7.1.0/known-limitations.md))
...
| 11 | **Provider canaries are absent** — nothing continuously verifies real provider APIs; "ready" in `xr doctor` means key present + endpoint answering, not key-validated. | verification | providers | — | release excerpt §6; tracker R-6 |
