...
export function InstallCmd() {
  return (
    <div className="group flex items-center gap-2 rounded-xl border border-white/10 bg-black/40 backdrop-blur px-4 py-3 max-w-md shadow-[0_10px_40px_-10px_rgba(96,72,248,0.3)]">
