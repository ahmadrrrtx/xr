...
import { XrMark, XrLogo } from "@/components/Logo";
      ...
      <div className="mx-auto max-w-7xl px-6 relative">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              ...
              XR {site.version} ({site.codename}) — Trust, verified
              <ArrowRight className="h-3 w-3 text-zinc-400" />
            </Link>

            <div className="mt-6 mb-5">
              <XrLogo size={40} stacked />
            </div>

            <h1 className="text-[40px] sm:text-6xl lg:text-[68px] leading-[1.02] font-semibold tracking-tight text-gradient">
              Your AI agent<br />
              <span className="text-gradient-violet">you can actually trust.</span>
            </h1>
            <p className="mt-6 text-lg text-zinc-400 max-w-xl leading-relaxed">
              XR is a local-first AI operating system that plans, executes, and iterates
              — with your choice of model, a policy gate in front of every consequential
              action, and a tamper-evident audit trail. One system. Every surface.
            </p>
        ...
        <div className="mt-20 grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center gap-2 mb-3 text-xs text-zinc-400">
              <Cpu className="h-3.5 w-3.5" /> Control Center
            </div>
            <DashboardPreview />
          </div>
        </div>
    ...
    <section className="py-14 border-y border-white/5 bg-white/[0.01]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-[#05060a] to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-[#05060a] to-transparent" />
        </div>
      </div>
    </section>
  );
        ...
        <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            <div key={f.title} className="card p-6 group">
              <div className="h-10 w-10 rounded-xl flex items-center justify-center bg-gradient-to-br from-indigo-500/20 to-cyan-500/10 border border-white/10 group-hover:border-cyan/30 transition-colors">
    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 rounded-3xl border border-white/10 p-2 bg-gradient-to-b from-white/[0.04] to-transparent">
          <div className="rounded-2xl bg-[#0a0c12] p-8 md:p-12">
            <StackLayer name="Apps" desc="CLI · Editor extensions · Control Center · API" tone="from-indigo-500/20 to-transparent" />
            <StackConnector />
            <StackLayer name="Skill Layer" desc="Manifest-governed, composable units of work" tone="from-cyan-500/20 to-transparent" />
            <StackConnector />
            <StackLayer name="Agent Runtime" desc="Planner · Executor · Memory · Replay · Audit" tone="from-emerald-500/15 to-transparent" />
            <StackConnector />
            <StackLayer name="Model Gateway" desc="BYOK · Claude · GPT · Gemini · Open-weight · Local" tone="from-amber-500/15 to-transparent" />
            <StackConnector />
...
function StackLayer({
  ...
  return (
    <div className={`rounded-xl border border-white/10 bg-gradient-to-r ${tone} px-5 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2 transition-colors hover:border-white/20`}>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 p-10 md:p-16 text-center">
          <div
            ...
            style={{
              background:
                "radial-gradient(600px 300px at 50% 0%, rgba(84,111,255,0.24), transparent 70%)",
            }}
          />
          <div className="relative">
            <div className="mx-auto mb-6 w-fit"><XrMark size={56} /></div>
