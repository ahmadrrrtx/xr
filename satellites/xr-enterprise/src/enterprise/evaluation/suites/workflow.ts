...
import type { WorkspaceStore } from "@xr/core/state/workspace-store.ts";
import { openDatabase } from "@xr/core/state/write-gate.ts";
import { WorkflowRepository } from "@xr/core/execution/workflow/repository.ts";
import { WorkflowEngine } from "@xr/core/execution/workflow/engine.ts";
...
import { validateGraph } from "@xr/core/execution/workflow/nodes.ts";
import { runCapabilityContractTests } from "@xr/core/platform/capabilities/certification.ts";
import { descriptorFromTool } from "@xr/core/platform/capabilities/adapters.ts";
import type { CapabilityDescriptor } from "@xr/core/platform/capabilities/types.ts";
import type { Tool } from "@xr/core/core/types.ts";
