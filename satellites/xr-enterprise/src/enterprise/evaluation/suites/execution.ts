...
import { ExecutionRepo, adaptWorkspaceStore } from "@xr/core/execution/repository.ts";
import { ExecutionService } from "@xr/core/execution/service.ts";
import { openDatabase } from "@xr/core/state/write-gate.ts";
import { isSideEffectSafe } from "@xr/core/execution/checkpoint.ts";
import { isTerminal, sideEffectPossible, TERMINAL_STATES } from "@xr/core/execution/state-machine.ts";
