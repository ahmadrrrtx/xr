...
import type { Command, CommandContext } from "@xr/core/core/command-registry.ts";
import { Tokens } from "@xr/core/core/tokens.ts";
import { colors as C, heading, ok, warn, error } from "@xr/core/interfaces/cli.ts";
