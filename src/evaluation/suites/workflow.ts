 ...
 *   - src/workflow/*      (definitions, versioning, integrity, human gates)
 *   - src/capabilities/*  (contract certification, descriptor validation)
...
const humanGateHolds: ScenarioDefinition = {
  ...
  contracts: ["src/workflow/engine.ts#WorkflowEngine", "src/workflow/nodes.ts#humanApproval"],
  profiles: [],
  offlineCapable: true,
...
const definitionIntegrity: ScenarioDefinition = {
  ...
  set: "independent",
  determinism: "deterministic",
  contracts: ["src/workflow/versioning.ts#verifyIntegrity", "src/workflow/nodes.ts#validateGraph"],
  profiles: [],
  offlineCapable: true,
...
const versionMigrationSafety: ScenarioDefinition = {
  ...
  determinism: "deterministic",
  contracts: [
    "src/workflow/versioning.ts#canMigrateActiveRun",
    "src/workflow/versioning.ts#createNewVersion",
  ],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
...
const capabilityEscalationRefused: ScenarioDefinition = {
  ...
  set: "independent",
  determinism: "deterministic",
  contracts: ["src/capabilities/certification.ts#runCapabilityContractTests"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
