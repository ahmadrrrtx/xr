 ...
 *   - src/trust/classify.ts   (classifyRisk)
 *   - src/trust/policy.ts     (decidePlacement, minPlacementForTier)
 *   - src/trust/types.ts      (RISK_TIER_ORDER, tierAtLeast)
 *
...
import { classifyRisk } from "../../trust/classify.ts";
import { decidePlacement, minPlacementForTier, type PlacementCapabilities } from "../../trust/policy.ts";
import { RISK_TIER_ORDER, type TrustRequest } from "../../trust/types.ts";
...
const riskEscalation: ScenarioDefinition = {
  ...
  contracts: ["src/trust/classify.ts#classifyRisk"],
  profiles: [],
  offlineCapable: true,
...
const failClosed: ScenarioDefinition = {
  ...
  set: "independent",
  determinism: "deterministic",
  contracts: ["src/trust/policy.ts#decidePlacement"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
...
const placementSufficiency: ScenarioDefinition = {
  ...
  set: "validation",
  determinism: "deterministic",
  contracts: ["src/trust/policy.ts#decidePlacement", "src/trust/policy.ts#minPlacementForTier"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
...
const tierOrdering: ScenarioDefinition = {
  ...
  set: "independent",
  determinism: "deterministic",
  contracts: ["src/trust/classify.ts#classifyRisk", "src/trust/types.ts#RISK_TIER_ORDER"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
