...
const contractsAreDiscoverable: ScenarioDefinition = {
  ...
  run: async (ctx) => {
    ...
    const barrels: { name: string; load: () => Promise<Record<string, unknown>> }[] = [
      ...
      { name: "trust", load: () => import("../../trust/index.ts") },
      { name: "context", load: () => import("../../context/index.ts") },
      { name: "workflow", load: () => import("../../workflow/index.ts") },
      { name: "capabilities", load: () => import("../../capabilities/index.ts") },
      { name: "intelligence", load: () => import("../../intelligence/index.ts") },
      { name: "environment", load: () => import("../../environment/index.ts") },
      { name: "deployment", load: () => import("../../deployment/index.ts") },
      { name: "enterprise", load: () => import("../../enterprise/index.ts") },
    ];
...
const metricsAreDocumented: ScenarioDefinition = {
  ...
  set: "independent",
  determinism: "deterministic",
  contracts: ["src/evaluation/metrics.ts#METRIC_DEFINITIONS"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
...
const refusalsAreUnderstandable: ScenarioDefinition = {
  ...
  set: "validation",
  determinism: "deterministic",
  contracts: ["src/trust/policy.ts#decidePlacement", "src/context/poison.ts#admitContextWrite"],
  profiles: [],
  offlineCapable: true,
  allowedEffects: NO_EXTERNAL_EFFECTS,
  budget: BUDGET,
  ...
  run: async (ctx) => {
    const { classifyRisk } = await import("../../trust/classify.ts");
    const { decidePlacement } = await import("../../trust/policy.ts");
...
const approvalsExplainConsequence: ScenarioDefinition = {
  ...
  run: async (ctx) => {
    const { assessEnvironmentAction } = await import("../../environment/classify.ts");
    const { EnvironmentActionRequestSchema } = await import("../../environment/types.ts");
