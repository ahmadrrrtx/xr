...
export const CATALOG: CatalogEntry[] = [
  ...
  {
    name: "hygiene",
    description: "local HOST hygiene: process, startup, miner and privacy scanning (not the enforcement boundary — see ADR-0027)",
    usage: "xr hygiene [status|scan|processes|startup|privacy|doctor|…]",
    group: "trust",
    glyph: "shield",
    aliases: ["shield", "security"],
    needsKernel: true,
    examples: [
      { cmd: "xr hygiene status", description: "host hygiene overview" },
      { cmd: "xr hygiene scan", description: "quick heuristic host scan" },
    ],
    related: ["audit", "doctor", "attacks", "trust", "capabilities"],
    topics: ["hygiene", "shield", "security", "trust", "host"],
  },
  {
    name: "trust",
  ...
  {
    name: "business",
    description: "MOVED to @rrrtx/business-os (Phase 5 · ADR-0028) — install it to use the operating layer",
    usage: "xr business  ·  see: bun add -g @rrrtx/business-os",
    group: "work",
    glyph: "task",
    aliases: ["biz"],
    needsKernel: false,
    examples: [
      { cmd: "bun add -g @rrrtx/business-os", description: "install the extension" },
      { cmd: "xr-business status", description: "operating layer status (satellite binary)" },
    ],
    related: ["run", "agents"],
    topics: ["business", "outcomes", "workflow", "approvals", "work", "satellite"],
  },
  {
    name: "evaluate",
    description: "MOVED to @rrrtx/xr-enterprise (Phase 5 · ADR-0028) — the evaluation harness ships as a satellite",
    usage: "xr evaluate  ·  see: bun add -g @rrrtx/xr-enterprise",
    group: "trust",
    glyph: "shield",
    aliases: ["eval", "benchmark"],
    needsKernel: false,
    examples: [
      { cmd: "bun add -g @rrrtx/xr-enterprise", description: "install the satellite" },
      { cmd: "xr-enterprise evaluate run --offline", description: "run the offline benchmark subset" },
    ],
    related: ["trust", "capabilities", "doctor"],
    topics: ["evaluation", "benchmark", "evidence", "certification", "satellite"],
  },
  {
    name: "enterprise",
    description: "MOVED to @rrrtx/xr-enterprise (Phase 5 · ADR-0028) — org policy, authority, audit export, SLOs, incidents, recovery",
    usage: "xr enterprise  ·  see: bun add -g @rrrtx/xr-enterprise",
    group: "trust",
    glyph: "shield",
    aliases: ["ent"],
    needsKernel: false,
    ...
    related: ["audit", "trust", "capabilities", "hygiene"],
    topics: ["enterprise", "policy", "audit", "compliance", "operations", "trust", "satellite"],
  },
