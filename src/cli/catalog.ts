...
export const CATALOG: CatalogEntry[] = [
  ...
  {
    name: "providers",
    description: "manage LLM providers (list, set, add, test, health)",
    ...
    needsKernel: true,
    examples: [
      { cmd: "xr providers list", description: "all providers + key status" },
      { cmd: "xr providers set ollama qwen2.5:7b", description: "switch active" },
      { cmd: "xr providers test", description: "health-check providers" },
    ],
    related: ["models", "budget", "status"],
    topics: ["providers", "models", "intelligence"],
  },
  {
    name: "models",
    description: "local models: recommend, install, list, test",
    ...
    related: ["providers", "doctor", "status"],
