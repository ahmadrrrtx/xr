...
export const METRIC_DEFINITIONS: readonly MetricDefinition[] = Object.freeze([
  ...
  def(
    ...
    "boolean",
    "higher_better",
    "src/runtime/trust/authority.ts, src/platform/capabilities/authority.ts",
    [],
  ),
  def(
    ...
    "boolean",
    "higher_better",
    "src/runtime/trust/policy.ts (decidePlacement)",
  ...
  def(
    ...
    "boolean",
    "higher_better",
    "src/platform/environment/classify.ts, workflow human nodes",
