...
export const MCP_TRANSPORTS = ["stdio", "sse", "http", "streamable-http"] as const;
...
export type McpToolDef = McpTool;
export type McpResourceDef = McpResource;
export type McpPromptDef = McpPrompt;
